...
function formularioEnviado(resposta){
  if(resposta.ok) {
    formulario.innerHTML = '<p class="font-1-p cor-p2" style="padding: 2rem; border-radius: 4px; background: var(--cor-0);"><span class="cor-p1 font-3-t">Mensagem enviada,</span> em breve entrarei em contato. Geralmente respondo em até 24 horas.</p>';
  } else {
